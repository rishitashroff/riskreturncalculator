...
ui <- page_navbar(
    ...
    tags$div(
     tags$h5(
       "This app serves as a financial tool for investors to make informed decisions by understanding
        ...
        the variance of the stock depends on the mean variance of other stocks in the same sector. However, if
        you are someone who has more financial knowledge, you may select the 'Get Stocks with Similar
        Price'. This will indicate that there is more certainty in the prior belief."),
     tags$br(),
     ...
     tags$h5("Alpha Likelihood: A weight of how strongly you believe the observed data influences the
              ...
              2005."),
     tags$h5("Alpha Prior: A weight of how strongly you believe your initial guess influences the variance
              of a stock. Remember, the initial guess here is that the variance of a stock is dependent on
              the mean variance of other similar stocks in the same sector."),
  ...
  nav_menu(
    ...
    nav_item(tags$a("Project Report", href = "savepdfingoogledriveandshare")),
    nav_item(tags$a("Virtual Poster", href = "savepresingoogledriveandshare"))
  ),
